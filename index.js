...
let result = userPreference = 'Regular' ? 'Regular' : 'Sugar-free'
console.log(result);
...
let outcome = heartRate < 100 ? "Boost needed!" : "Energy levels are high!";
console.log(outcome);
...
let currentHour = 22; 
let comment = currentHour >= 7 && currentHour < 24 ? "Unleash the beast!" : "Better stick to water.";
console.log(comment);
